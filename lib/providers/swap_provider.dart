...
class SwapProvider with ChangeNotifier {
  ...
  Future<bool> createSwap({
    ...
    try {
      ...
      // Lightweight email notify (no backend): open user's email app prefilled
      try {
        ...
        if (owner != null && owner.email.isNotEmpty) {
          ...
          final body = Uri.encodeComponent(
              ...
              '$senderName has sent you a swap offer for your book "${book.title}".\n\n'
              'To respond, open BookSwap > Requests, then Accept or Decline.\n\n'
              'Details:\n- Book: ${book.title}\n- From: $senderName\n- Date: ${DateTime.now()}\n\n'
              'This email was generated by the app on the sender\'s device.');
          final mailto = Uri.parse('mailto:${owner.email}?subject=$subject&body=$body');
          await launchUrl(mailto, mode: LaunchMode.externalApplication);
        }
      } catch (_) {
        // ignore email open errors
      }
